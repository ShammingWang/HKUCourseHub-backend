...
from backend.app.main.api.v1.auth import router as auth_router  # auth package router
from backend.app.main.api.v1.main import router as main_router  # main package router
