...
from backend.app.main.schema.user import AuthSchemaParam, AuthLoginParam
from backend.app.main.schema.token import GetSwaggerToken, GetNewToken, GetUserInfoDetail
from backend.app.main.service.auth_service import auth_service
...
@router.post(
    '/login',
    summary='用户登录',
    description='json 格式登录', # , 仅支持在第三方api工具调试, 例如: postman、apifox
